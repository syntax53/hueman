...
if ( ! function_exists( 'alx_google_fonts' ) ) {
	...
	function alx_google_fonts () {
		if ( ot_get_option('dynamic-styles') != 'off' ) {
			...
			//if ( ot_get_option( 'font' ) == 'droid-serif' ) { echo '<link rel="stylesheet" id="droid-serif-asd-css" href="//fonts.googleapis.com/css?family=Droid+Serif:400,400italic,700" type="text/css" media="all" >'. "\n"; }
...
if ( ! function_exists( 'alx_dynamic_css' ) ) {
	...
	function alx_dynamic_css() {
		if ( ot_get_option('dynamic-styles') != 'off' ) {
			...
			if ( ot_get_option( 'font' ) == 'titillium-web' ) { $styles .= 'body { font-family: "Titillium", Arial, sans-serif; }'."\n"; }
...
@media only screen and (min-width: 720px) {
	#nav-header .nav ul { background-color: '.ot_get_option('color-header-menu').'; }
			...
			if (ot_get_option('color-header-menu') != '') {
				$styles .= '.sidebar .widget > h3 { background-color: '.ot_get_option('color-header-menu').'; }';
			}
